  ...
  <section class="section bgg">
    <div class="container">    
        <div class="title-area">
            <h2>FUNCTIONS <small class="hidden-xs">FUNCTIONS</small></h2>
            <div class="bread">
                <ol class="breadcrumb">
                    <li><a href="#">Home</a></li>
            ...
            <div class="widget">
                <div class="large-widget m30">
                    <div class="post-desc">
                        ...
                        <ul>
                            <li>Updation through emails</li>
                            <li>Training and Seminars Collective</li>
                            <li>Representation before the statutory bodies</li>
                            <li>Handling of collective industries grievances</li>
                            <li>Creation of MARG</li>
                            <li>Collective CSR</li>
                        </ul>
