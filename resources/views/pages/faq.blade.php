  ...
  <section class="section bgg">
    <div class="container">    
        <div class="title-area">
            <h2>FAQ's <small class="hidden-xs">FAQ's</small></h2>
            <div class="bread">
                <ol class="breadcrumb">
                    <li><a href="#">Home</a></li>
            ...
            <div class="widget">
                <div class="large-widget m30">
                    <div class="post-desc">
                        ...
                        <ul>
                            <li>What are the local rules?</li>
                            <li>Why DNH is preferred place for Industries?</li>
                            <li>What is the law & governance in UT?</li>
                            <li>Why SIA is the first hand of UT in the industry?</li>
                            <li>What are the Important Websites for an Industry?</li>
                            <li>Which are prominent spare parts & hardware suppliers in UT?</li>
                            <li>Which are software developers in the UT?</li>
                            <li>Who are prominent consultances?</li>
                            <li>Who is a president of Bar Association?</li>
                            <li>What are the emergency no. of the UT?</li>
                            <li>To whom I should contact incase of power failure in my Industry?</li>
                            <li>To whom I should contact in my energy bill discretion?</li>
                            <li>What are the concessions available for the Industries?</li>
                        </ul>
