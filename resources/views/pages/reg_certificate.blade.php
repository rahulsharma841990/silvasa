  ...
  <section class="section bgg">
    <div class="container">    
        <div class="title-area">
            <h2>REGISTRATION CERTIFICATE <small class="hidden-xs">REGISTRATION CERTIFICATE</small></h2>
            <div class="bread">
                <ol class="breadcrumb">
                    <li><a href="#">Home</a></li>
        ...
        <div class="col-md-9 col-sm-9 col-xs-12 m22 single-post">
            <div class="widget">
                <div class="large-widget m30">
                    <div class="post-desc">
                        <img src="{{asset('images/1.jpg')}}" style="width: 30%;">
                        <img src="{{asset('images/2.jpg')}}" style="width: 30%;">
                        <img src="{{asset('images/3.jpg')}}" style="width: 30%;">
