                ...
                <div class="row">
                    ...
                    <div class="col-md-9 col-sm-12">
                        <div class="ads-widget clearfix">
                            <a href="#"><img src="{{asset('template/upload/banner_03.jpg')}}" alt="" class="img-responsive"></a>
                        </div>
                        <!-- end ads-widget -->
                    </div>
                    <!-- end col -->
                    ...
                    <div class="container-full">
                        ...
                        <div id="navbar" class="navbar-collapse collapse">
                            <ul class="nav navbar-nav">
                                <li class="active"><a href="{{asset('/')}}"><i class="fa fa-home"></i> Home</a></li>
                             {{--    <li class="dropdown hasmenu">
                                                            ...
                                                            <div class="mini-widget m30">
                                                                <div class="post clearfix">
                                                                    <div class="mini-widget-thumb">
                                                                        <a href="single.html">
                                                                            <img alt="" src="{{asset('template/upload/widget_01.jpg')}}" class="img-responsive">
                                                                        </a>
                                                                    </div>
                                                                ...
                                                                <div class="post clearfix">
                                                                    <div class="mini-widget-thumb">
                                                                        <a href="single.html">
                                                                            <img alt="" src="{{asset('template/upload/widget_02.jpg')}}" class="img-responsive">
                                                                        </a>
                                                                    </div>
                                                                    <div class="mini-widget-title">
                                ...
                                <li class="dropdown hasmenu">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Organization <span class="fa fa-angle-down"></span></a>
                                    <ul class="dropdown-menu">
                                 ...
                                 @else
                                    ...
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> My Membership <span class="fa fa-angle-down"></span></a>
                                     <ul class="dropdown-menu">
                                        ...
                                        <li><a href="{{url('recruitment')}}">Check before any Recruitment</a></li>
                                        <li><a href="{{url('localrules')}}"> local rules</a></li>
