...
<body>
    ...
    <div id="wrapper">
        ...
        <section class="section banner text-center" style="background-image:url('upload/reviewbg.jpg');" data-img-width="1688" data-img-height="470" data-diff="100">
            <div class="container">    
                            ...
                            <div class="post-desc">
                                ...
                                <div class="reviewlist review-posts row m30">
                                    ...
                                    <div class="post-review col-md-6 col-sm-12 first">
                                        <div class="post-media entry">
                                            <a href="single-review.html" title="">
                                            <img src="upload/review_07.jpg" alt="" class="img-responsive">
                                            <div class="magnifier">
                                                <div class="review-stat">
                                                    <div class="rating">
                                                        <i class="fa fa-star"></i>
                                        ...
                                        <div class="post-title">
                                            <h3><a href="single-review.html">Mercedes Benz Hybrid Technology Comes with Space Features!</a></h3>
                                        </div><!-- end post-title -->
                                    </div><!-- end post-review -->
                                    ...
                                    <div class="post-review col-md-6 col-sm-12 last">
                                        <div class="post-media entry">
                                            <a href="single-review.html" title="">
                                            <img src="upload/review_08.jpg" alt="" class="img-responsive">
                                            <div class="magnifier">
                                                <div class="review-stat">
                                                    <div class="rating">
                                                        <i class="fa fa-star"></i>
                                        ...
                                        <div class="post-title">
                                            <h3><a href="single-review.html">Don't forget check Google Television Technology</a></h3>
                                        </div><!-- end post-title -->
                                    </div><!-- end post-review -->
                                    ...
                                    <div class="post-review col-md-6 col-sm-12 first">
                                        <div class="post-media entry">
                                            <a href="single-review.html" title="">
                                            <img src="upload/review_09.jpg" alt="" class="img-responsive">
                                            <div class="magnifier">
                                                <div class="review-stat">
                                                    <div class="rating">
                                                        <i class="fa fa-star"></i>
                                    ...
                                    <div class="post-review col-md-6 col-sm-12 last">
                                        <div class="post-media entry">
                                            <a href="single-review.html" title="">
                                            <img src="upload/review_10.jpg" alt="" class="img-responsive">
                                            <div class="magnifier">
                                                <div class="review-stat">
                                                    <div class="rating">
                                                        <i class="fa fa-star"></i>
                                        ...
                                        <div class="post-title">
                                            <h3><a href="single-review.html">Windows Desktop and Laptop Review March 2016</a></h3>
                                        </div><!-- end post-title -->
                                    </div><!-- end post-review -->
                                    ...
                                    <div class="post-review col-md-6 col-sm-12 first">
                                        <div class="post-media entry">
                                            <a href="single-review.html" title="">
                                            <img src="upload/review_11.jpg" alt="" class="img-responsive">
                                            <div class="magnifier">
                                                <div class="review-stat">
                                                    <div class="rating">
                                                        <i class="fa fa-star"></i>
                                        ...
                                        <div class="post-title">
                                            <h3><a href="single-review.html">When You can Purchase any Windows Computer, You Will get Awesomeness</a></h3>
                                        </div><!-- end post-title -->
                                    </div><!-- end post-review -->
                                    ...
                                    <div class="post-review col-md-6 col-sm-12 last">
                                        <div class="post-media entry">
                                            <a href="single-review.html" title="">
                                            <img src="upload/review_12.jpg" alt="" class="img-responsive">
                                            <div class="magnifier">
                                                <div class="review-stat">
                                                    <div class="rating">
                                                        <i class="fa fa-star"></i>
                                        ...
                                        <div class="post-title">
                                            <h3><a href="single-review.html">Nokia Mobile Phone Review, the U.K. banking startup, opens public Beta</a></h3>
                                        </div><!-- end post-title -->
                                    </div><!-- end post-review -->
