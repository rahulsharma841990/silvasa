...
<body>
    ...
    <div id="wrapper">
        ...
        <section class="section banner text-center" style="background-image:url('upload/jobbg.jpg');" data-img-width="1688" data-img-height="470" data-diff="100">
            <div class="container">    
                            ...
                            <div class="post row clearfix">
                                <div class="col-md-4">
                                    <div class="post-media">
                                        <a href="single.html">
                                            <img alt="" src="upload/job.jpg" class="img-responsive">
                                        </a>
                                        <a href="#appljpob" class="btn btn-primary btn-block"><i class="fa fa-check"></i> Apply Job</a> 
                                    </div>
                                </div>
                                ...
                                <div class="col-md-8">
                                    <div class="title-area">
                                        <div class="colorfulcats">
                                            <a href="#"><span class="label label-primary">Full time</span></a>
                                        </div>
                                        <a href="single-job.html"><h3>We are looking a team member (In Office)</h3></a>

                                        <div class="job-details">
                                            <ul class="">
                                                <li><strong><i class="fa fa-user"></i> Publisher :</strong> <a href="#"> John DOE</a></li>
                                                <li><strong><i class="fa fa-briefcase"></i> Job Category :</strong> <a href="#"> Web Design</a></li>
                                                <li><strong><i class="fa fa-dollar"></i> Job Price :</strong> $21.00 - $120.00</li>
                                                <li><strong><i class="fa fa-clock-o"></i> Delivery Time :</strong> 5 Days</li>
                                                <li><strong><i class="fa fa-cog"></i> Revision :</strong> 3 Times</li>
                                            </ul>
                                        </div>
                                    </div><!-- /.pull-right -->
                                </div>
                        ...
                        <div class="large-widget m30">
                            <div class="post row clearfix">
                                <div class="col-md-4">
                                    <div class="post-media">
                                        <a href="single.html">
                                            <img alt="" src="upload/job_01.jpg" class="img-responsive">
                                        </a>
                                        <a href="#appljpob" class="btn btn-primary btn-block"><i class="fa fa-check"></i> Apply Job</a> 
                                    </div>
                                </div>
                                ...
                                <div class="col-md-8">
                                    <div class="title-area">
                                        <div class="colorfulcats">
                                            <a href="#"><span class="label label-info">Freelancer</span></a>
                                        </div>
                                        <a href="single-job.html"><h3>Anybody build my email subscribe form With Mailchimp email service?</h3></a>

                                        <div class="job-details">
                                            <ul class="">
                                                <li><strong><i class="fa fa-user"></i> Publisher :</strong> <a href="#"> Mark SANDERS</a></li>
                                                <li><strong><i class="fa fa-briefcase"></i> Job Category :</strong> <a href="#"> Email Marketing</a></li>
                                                <li><strong><i class="fa fa-dollar"></i> Job Price :</strong> $10.00 - $21.00</li>
                                                <li><strong><i class="fa fa-clock-o"></i> Delivery Time :</strong> 1 Days</li>
                                                <li><strong><i class="fa fa-cog"></i> Revision :</strong> 1 Times</li>
                                            </ul>
                                        </div>
                                    </div><!-- /.pull-right -->
                                </div>
                        ...
                        <div class="large-widget m30">
                            <div class="post row clearfix">
                                <div class="col-md-4">
                                    <div class="post-media">
                                        <a href="single.html">
                                            <img alt="" src="upload/job_02.jpg" class="img-responsive">
                                        </a>
                                        <a href="#appljpob" class="btn btn-primary btn-block"><i class="fa fa-check"></i> Apply Job</a> 
                                    </div>
                                </div>
                                ...
                                <div class="col-md-8">
                                    <div class="title-area">
                                        ...
                                        <a href="single-job.html"><h3>Looking professional logo designer, who want to design our company logo?</h3></a>

                                        <div class="job-details">
                                            <ul class="">
                                                <li><strong><i class="fa fa-user"></i> Publisher :</strong> <a href="#"> Amly LOCKER</a></li>
                                                <li><strong><i class="fa fa-briefcase"></i> Job Category :</strong> <a href="#"> Logo Design</a></li>
                                                <li><strong><i class="fa fa-dollar"></i> Job Price :</strong> $44.00 - $129.00</li>
                                                <li><strong><i class="fa fa-clock-o"></i> Delivery Time :</strong> 3 Days</li>
                                                <li><strong><i class="fa fa-cog"></i> Revision :</strong> 4 Times</li>
                                            </ul>
                                        </div>
                                    </div><!-- /.pull-right -->
                                </div>
                        ...
                        <div class="large-widget m30">
                            <div class="post row clearfix">
                                <div class="col-md-4">
                                    <div class="post-media">
                                        <a href="single.html">
                                            <img alt="" src="upload/job_04.jpg" class="img-responsive">
                                        </a>
                                        <a href="#appljpob" class="btn btn-primary btn-block"><i class="fa fa-check"></i> Apply Job</a> 
                                    </div>
                                </div>
                                ...
                                <div class="col-md-8">
                                    <div class="title-area">
                                        ...
                                        <a href="single-job.html"><h3>Fix my template JavaScript problem - Its not work on Google Chrome</h3></a>

                                        <div class="job-details">
                                            <ul class="">
                                                <li><strong><i class="fa fa-user"></i> Publisher :</strong> <a href="#"> Jenny DOE</a></li>
                                                <li><strong><i class="fa fa-briefcase"></i> Job Category :</strong> <a href="#"> Website Design</a></li>
                                                <li><strong><i class="fa fa-dollar"></i> Job Price :</strong> $10.00 - $20.00</li>
                                                <li><strong><i class="fa fa-clock-o"></i> Delivery Time :</strong> 1 Days</li>
                                                <li><strong><i class="fa fa-cog"></i> Revision :</strong> 1 Times</li>
                                            </ul>
                                        </div>
                        ...
                        <div class="large-widget m30">
                            <div class="post row clearfix">
                                <div class="col-md-4">
                                    <div class="post-media">
                                        <a href="single.html">
                                            <img alt="" src="upload/job_03.jpg" class="img-responsive">
                                        </a>
                                        <a href="#appljpob" class="btn btn-primary btn-block"><i class="fa fa-check"></i> Apply Job</a> 
                                    </div>
                                </div>
                                ...
                                <div class="col-md-8">
                                    <div class="title-area">
                                        ...
                                        <a href="single-job.html"><h3>Bootstrap Framewok - Convert my PSD template to Bootstrap template</h3></a>

                                        <div class="job-details">
                                            <ul class="">
                                                <li><strong><i class="fa fa-user"></i> Publisher :</strong> <a href="#"> Amly LOCKER</a></li>
                                                <li><strong><i class="fa fa-briefcase"></i> Job Category :</strong> <a href="#"> Website Design</a></li>
                                                <li><strong><i class="fa fa-dollar"></i> Job Price :</strong> $344.00 - $1256.00</li>
                                                <li><strong><i class="fa fa-clock-o"></i> Delivery Time :</strong> 12 Days</li>
                                                <li><strong><i class="fa fa-cog"></i> Revision :</strong> 5 Times</li>
                                            </ul>
                                        </div>
                                    </div><!-- /.pull-right -->
                                </div>
